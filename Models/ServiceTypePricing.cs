...
namespace Cleaning_Quote.Models
{
    public class ServiceTypePricing
    {
        ...
        public decimal FridgeHoursEach { get; set; } = 1.00m;
        public int FridgeComplexity { get; set; } = 2;
        public decimal OvenHoursEach { get; set; } = 1.00m;
        public int OvenComplexity { get; set; } = 2;
        public decimal CeilingFanHoursEach { get; set; } = 0.17m;
        ...
        public static ServiceTypePricing Default(string serviceType)
        {
            var defaults = new ServiceTypePricing
            {
                ...
                FridgeHoursEach = 1.00m,
                FridgeComplexity = 2,
                OvenHoursEach = 1.00m,
                OvenComplexity = 2,
                CeilingFanHoursEach = 0.17m,
