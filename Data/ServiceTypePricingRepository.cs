...
";
            ...
            using (var reader = cmd.ExecuteReader())
            {
                if (reader.Read())
                {
                    ...
                    var windowInsideRate = GetOptionalDecimal(reader, 25, defaults.WindowInsideRate);
                    var windowOutsideRate = GetOptionalDecimal(reader, 26, defaults.WindowOutsideRate);
                    var defaultRoomType = GetOptionalString(reader, 27);
                    var defaultRoomLevel = GetOptionalString(reader, 28);
                    var defaultRoomSize = GetOptionalString(reader, 29);
                    var defaultRoomComplexity = GetOptionalInt(reader, 30, defaults.DefaultRoomComplexity);
                    var defaultSubItemType = GetOptionalString(reader, 31);
                    var defaultWindowSize = GetOptionalString(reader, 32);
                    ...
                    pricing = new ServiceTypePricing
                    {
                        ...
                        FirstCleanRate = GetOptionalDecimal(reader, 17, defaults.FirstCleanRate),
                        FirstCleanMinimum = GetOptionalDecimal(reader, 18, defaults.FirstCleanMinimum),
                        DeepCleanRate = GetOptionalDecimal(reader, 19, defaults.DeepCleanRate),
                        DeepCleanMinimum = GetOptionalDecimal(reader, 20, defaults.DeepCleanMinimum),
                        MaintenanceRate = GetOptionalDecimal(reader, 21, defaults.MaintenanceRate),
                        MaintenanceMinimum = GetOptionalDecimal(reader, 22, defaults.MaintenanceMinimum),
                        OneTimeDeepCleanRate = GetOptionalDecimal(reader, 23, defaults.OneTimeDeepCleanRate),
                        OneTimeDeepCleanMinimum = GetOptionalDecimal(reader, 24, defaults.OneTimeDeepCleanMinimum),
                        ...
                        RoomBathroomFullMinutes = GetOptionalInt(reader, 33, defaults.RoomBathroomFullMinutes),
                        RoomBathroomHalfMinutes = GetOptionalInt(reader, 34, defaults.RoomBathroomHalfMinutes),
                        RoomBathroomMasterMinutes = GetOptionalInt(reader, 35, defaults.RoomBathroomMasterMinutes),
                        RoomBedroomMinutes = GetOptionalInt(reader, 36, defaults.RoomBedroomMinutes),
                        RoomBedroomMasterMinutes = GetOptionalInt(reader, 37, defaults.RoomBedroomMasterMinutes),
                        RoomDiningRoomMinutes = GetOptionalInt(reader, 38, defaults.RoomDiningRoomMinutes),
                        RoomEntryMinutes = GetOptionalInt(reader, 39, defaults.RoomEntryMinutes),
                        RoomFamilyRoomMinutes = GetOptionalInt(reader, 40, defaults.RoomFamilyRoomMinutes),
                        RoomHallwayMinutes = GetOptionalInt(reader, 41, defaults.RoomHallwayMinutes),
                        RoomKitchenMinutes = GetOptionalInt(reader, 42, defaults.RoomKitchenMinutes),
